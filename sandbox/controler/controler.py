...
class Controler:
    ...
    def speed_loop(self, set_point_generator):
        ...
        speed = self._enc.speed
        self._pid.update(t, speed)
        cmd = self._pid.get_driving_value()
        
        while(self._pid.set_point != None):
            print ("time : ", t, "speed : ", speed,"Cmd : ", cmd, "set_point : ", self._pid.set_point, "Epsi : ", self._pid._last_epsilon)
            speed = self._enc.speed
            self._pid.update(t, speed)
            cmd = self._pid.get_driving_value()
    ...
    def speed_step(self, ticks_start, set_point_generator):
...
#             print ("Ret loop 1 : ", ret1, "Ret loop 2 : ", ret2)
    ...
    def speed_loop(self, set_point_generator_ch1, set_point_generator_ch2):
        ...
        while (ret1==True and ret2==True):
#         while (ret1 == True):
            ret1 = self._ch1.speed_step(ticks_start, set_point_generator_ch1)
            ret2 = self._ch2.speed_step(ticks_start, set_point_generator_ch2)
            sleep_ms(10)
#             print ("Ret loop 1 : ", ret1, "Ret loop 2 : ", ret2)
...
#     print("---")
#     test_asservissement_ch1_speed()
    print("---")
    test_asservissement_2chan_speed()
    print("---")
    test_motor_stop()  
